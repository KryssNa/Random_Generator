...
const Page: React.FC = () => {
  return (
    ...
    >
      <header className='py-[10px] px-4 max-md:pt-2 max-md:pb-3 max-md:px-6'>
        <div className='container px-4 sm:px-8 md:px-12 lg:px-24 pb-2'>
          <div className='flex justify-around px-2 items-center'>
            <div className='flex flex-col justify-center items-center text-center  md:text-left'>
              <p className='text-[#44546A] text-[15px] md:text-xl pt-2'>
                State of Kuwait
              </p>
              <p className='text-[#8497b0] text-[15px] md:text-xl font-bold '>
      ...
      <main className='flex-grow'>
        <div
          className='bg-[#F3F5F7] p-[10px] text-center mb-5 border-b-[3px]'
          style={{ borderColor: "rgb(214, 220, 229)" }}
        >
          <p className='text-[#1b47a1] text-[10px] md:text-xs'>
        ...
        <div className='container mx-auto px-4 text-center'>
          <Image
            ...
            width={50}
            height={50}
            className='mx-auto w-[50px] h-auto mb-2'
          />
          <p className='text-[#F37489] font-bold text-[10px]  md:text-xs '>
            وثيقة غير صالحة
          </p>
          <p className='text-[#F37489] text-[10px] font-bold  md:text-xs'>
            Invalid document
          </p>
        </div>
      </main>
      <footer
        className='bg-[#F3F5F7] py-4 mt-8 border-[#D6DCE5] border-b-4'
        style={{ borderBottom: "4px solid rgb(214,220,229)" }}
      >
        <div className='container mx-auto px-4 text-center'>
          <p className='text-[#1b47a1] text-[10px]  md:text-xs'>
